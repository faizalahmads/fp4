...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase MyDB) {
        MyDB.execSQL("create Table users(username TEXT primary key, password TEXT, fullname TEXT)");
        MyDB.execSQL("create Table buses(id TEXT primary key, departure TEXT, arrival TEXT, data TEXT, total_seats TEXT)");
